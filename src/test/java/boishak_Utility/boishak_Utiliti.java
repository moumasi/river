...
public class boishak_Utiliti extends boishak_Base {
	                                       //anytime can change time here
...
public static void takeMyScreenshot(WebDriver driver, String screenshot) {
		...
		try {
			FileUtils.copyFile(srcfile, new File(correntdir+"/boishak_ScreenShots/"+screenshot+".png"));
		} catch (IOException e) {
